<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="Profile.aspx.cs" Inherits="Snackster.User.Profile" %>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <% Response.Write(Session["email"]); %>
                                        ...
                                        <h6 class="d-block">
                                            <a href="javascript:void(0);">
                                                <asp:Label ID="Label1" runat="server" ToolTip="Account Created On">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <ul class="nav nav-tabs mb-4" id="myTab" role="tablist">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link text-info" id="connectedServices-tab" data-toggle="tab" href="#connectedServices" role="tab" aria-controls="connectedServices" aria-selected="false"><i class="fa fa-id-badge mr-2"></i>Purchased History </a>
                                        </li>
                                    </ul>
                                    ...
                                    <div class="tab-content ml-1" id="myTabContent">
                                        ...
                                        <div class="tab-pane fade" id="connectedServices" role="tabpanel" aria-labelledby="ConnectedServices-tab">
                                            <asp:Repeater ID="rPurchaseHistory" runat="server" OnItemDataBound="rPurchaseHistory_ItemDataBound">
                                                <ItemTemplate>
                                                    <div class="container">
                                                        <div clss="row pt-1 pb-1" style="background-color: lightgray">
                                                            <div class="col-4">
